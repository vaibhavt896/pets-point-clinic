      ...
      <div className="footer__inner">
        ...
        <div className="footer__middle">
          ...
          <div className="footer__social">
            <a href="https://www.instagram.com/petspointkanpur/" target="_blank" rel="noopener noreferrer" aria-label="Instagram"><InstagramIcon /></a>
            <a href="https://www.facebook.com/petspointkanpur/" target="_blank" rel="noopener noreferrer" aria-label="Facebook"><FacebookIcon /></a>
          </div>
        </div>
        ...
        <div className="footer__bottom">
          ...
          <div className="footer__legal-links">
            <button onClick={() => setActiveModal('privacy')} className="footer__legal-btn">Privacy Policy</button>
            <span>·</span>
            <button onClick={() => setActiveModal('terms')} className="footer__legal-btn">Terms of Service</button>
          </div>
        </div>
      </div>
      <LegalModal isOpen={!!activeModal} onClose={() => setActiveModal(null)} data={activeModal ? legalData[activeModal] : null} />
    </footer>
  );
};
