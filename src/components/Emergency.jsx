  ...
  return (
    <section className="emergency">
      ...
      <div className="emergency__content" data-reveal>
        ...
        <h2 className="emergency__headline">Critical Care & Stabilization</h2>
        <p className="emergency__sub">
          When seconds matter, our clinical team acts.<br />
          A dedicated 24/7 trauma response unit, always ready.
        </p>
        ...
        >
          <span>Clinical Indicators for Immediate Intervention</span>
